                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="i-tanggal" class="form-control" name="tanggal" autocomplete="off" required>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label>Perihal</label>
                        <textarea id="i-perihal" class="form-control" cols="30" rows="3" name="perihal" required></textarea>
                    </div>
                    <div class="form-group">
                        <label>Berkas</label>
                        <input type="file" name="berkas" id="i-berkas">
                    </div>
                    <div class="col-12">
